...
class GatedGCNLayer(pyg_nn.conv.MessagePassing):
    ...
    def __init__(self, in_dim, out_dim, dropout, residual,
        ...
        '''
        in_dim = dimension of embeddings 
        out_dim = dimension of embeddings after the message passing
        dropout = some fraction between 0 and 1
        residual = boolean 
        '''
    ...
    def forward(self, batch):
        x, edge_index, e = batch.x, batch.edge_index, batch.edge_attr
