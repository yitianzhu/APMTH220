...
python plot_train_val.py --dataset-name "$DATASET_NAME" --result-folder "$RESULT_FOLDER" --checking-hops
python plot_param_diff_norms.py --dataset-name "$DATASET_NAME" --result-folder "$RESULT_FOLDER" --plot-downstream --checking-hops
python plot_param_grads.py --dataset-name "$DATASET_NAME" --result-folder "$RESULT_FOLDER" --plot-downstream --checking-hops
